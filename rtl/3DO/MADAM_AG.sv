...
//					CFL <= ~PFL;
	...
	wire         CFB_ACCESS = (BUS_STATE_FF == CFB_INIT1 ||
	                           BUS_STATE_FF == CFB_READ0 || BUS_STATE_FF == CFB_READ1 ||
									   BUS_STATE_FF == CFB_WRITE0 || BUS_STATE_FF == CFB_WRITE1);
	wire [ 1: 0] CFB_CAS = {SE_LEFT_WRITE&~SE_LEFT_ADDR[1]&PHASE1,SE_LEFT_WRITE&SE_LEFT_ADDR[1]&PHASE1}|{SE_RIGHT_WRITE&~SE_RIGHT_ADDR[1]&PHASE2,SE_RIGHT_WRITE&SE_RIGHT_ADDR[1]&PHASE2};
	...
	wire         CFB_DRAM0_SEL = SE_RIGHT_WRITE ? (SE_RIGHT_ADDR[23:2] >= (24'h000000>>2) && SE_RIGHT_ADDR[23:2] <= (24'h0FFFFF>>2)) : (SE_LEFT_ADDR[23:2] >= (24'h000000>>2) && SE_LEFT_ADDR[23:2] <= (24'h0FFFFF>>2));
	wire         CFB_DRAM1_SEL = SE_RIGHT_WRITE ? (SE_RIGHT_ADDR[23:2] >= (24'h100000>>2) && SE_RIGHT_ADDR[23:2] <= (24'h1FFFFF>>2)) : (SE_LEFT_ADDR[23:2] >= (24'h100000>>2) && SE_LEFT_ADDR[23:2] <= (24'h1FFFFF>>2));
	wire         CFB_VRAM_SEL  = SE_RIGHT_WRITE ? (SE_RIGHT_ADDR[23:2] >= (24'h200000>>2) && SE_RIGHT_ADDR[23:2] <= (24'h2FFFFF>>2)) : (SE_LEFT_ADDR[23:2] >= (24'h200000>>2) && SE_LEFT_ADDR[23:2] <= (24'h2FFFFF>>2));
	...
	assign LA       = SE_GRANT && CFB_ACCESS ? ((SE_RIGHT_WRITE && PHASE2/*!SE_RIGHT_ADDR[1]*/) ? SE_RIGHT_ADDR[23:2] : SE_LEFT_ADDR[23:2]) : CPU_GRANT && CPU_SPORT_SEL ? {4'b0000,AOUT[10:2],9'b000000000} : AOUT;
	...
	assign RA       = SE_GRANT && CFB_ACCESS ? ((SE_RIGHT_WRITE && PHASE2/* SE_RIGHT_ADDR[1]*/) ? SE_RIGHT_ADDR[23:2] : SE_LEFT_ADDR[23:2]) : CPU_GRANT && CPU_SPORT_SEL ? {4'b0000,AOUT[10:2],9'b000000000} : AOUT;
